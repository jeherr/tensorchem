...
def mset_to_smiles(filename):
    ...
    try:
        mol = xyz2mol(mset.at_nums, [atom.xyz for geom in mset.geometries for atom in geom.atoms], charge)
...
if __name__ == "__main__":
    with open("/mnt/sdb1/adriscoll/chemspider_data/chno_msets/meta_msetfile_smiles.txt", "w") as f:
        with Pool(32) as p:
            for file, smile in p.imap_unordered(mset_to_smiles, glob.iglob("/mnt/sdb1/adriscoll/chemspider_data/chno_msets/meta/*.mset"), 100):
